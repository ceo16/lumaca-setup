...
set emulators_black_list=(3dsen citron eden lemonade opengoal pico8 retroarch ryujinx steam sudachi suyu teknoparrot yuzu yuzu-early-access)
...
if not exist "!build_path!\system\version.info" (
    rem Correzione per la data, usa PowerShell per un formato affidabile
...
if not exist "!build_path!\%package_file%" (
    rem Blocco IF riscritto per chiarezza e robustezza
